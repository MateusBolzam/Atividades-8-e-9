...
public class RestaurantChain
{
    ...
    RestaurantChain() { m_chain = new ArrayList<>(); }

    public void createRestaurant(String name, String country) { m_chain.add(new Restaurant(name, country)); }

    public Restaurant getRestaurant(String name, String country)
    {
    ...
    public void printRestaurantsFilterName(String name)
    {
        System.out.println("--------------------------------------------------");
        for (int i = 0; i < m_chain.size(); i++)
        {
    ...
    public void printRestaurantsFilterCountry(String country)
    {
        System.out.println("--------------------------------------------------");
        for (int i = 0; i < m_chain.size(); i++)
        {
